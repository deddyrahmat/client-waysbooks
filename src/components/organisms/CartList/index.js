                ...
                <div className="xs:container xxl:container mx-auto px-10 pb-14">
                    ...
                    {cart.length > 0 ? (
                        ...
                        <div className="flex flex-col lg:flex-row lg:space-x-10 items-start">
                            ...
                            <div className="w-full lg:w-[40%]">
                                ...
                                <div className="float-right">
                                    ...
                                    <Buttons className="border-2 border-[#393939] bg-[#393939] rounded py-1.5 w-full min-w-[100px] text-center text-white hover:text-black hover:bg-white active:bg-white focus:outline-none focus:ring focus:ring-white mt-5 ">
                                        Pay
                                    </Buttons>
                                </div>
                            </div>
                      ...
                      <>
                        ...
                        <Buttons type="link" href="/" className="mt-3 block border-2 border-[#393939] bg-[#393939] rounded py-1.5 w-full md:w-2/12 text-white hover:text-black hover:bg-white active:bg-white focus:outline-none focus:ring focus:ring-white flex items-center justify-center space-x-1">
